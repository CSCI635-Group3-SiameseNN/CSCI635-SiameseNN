...
class SiameseNetwork:
    ...
    def __init__(
        ...
        # self.summary_writer = tf.summary.FileWriter(tensorboard_log_path) #NOTE
    ...
    def _construct_siamese_architecture(self, learning_rate_multipliers, l2_regularization_penalization):
        ...
        optimizer = Modified_SGD(lr=self.learning_rate, lr_multipliers=learning_rate_multipliers, momentum=0.5)
    ...
    def train_siamese_network(
        self, number_of_iterations, support_set_size, final_momentum, momentum_slope, evaluate_each, model_name
    ):
        ...
        for iteration in range(number_of_iterations):
            ...
            if (iteration + 1) % evaluate_each == 0:
                ...
                self._write_logs_to_tensorboard(
                    iteration, train_losses, train_accuracies, validation_accuracy, evaluate_each
                )
                count = 0
